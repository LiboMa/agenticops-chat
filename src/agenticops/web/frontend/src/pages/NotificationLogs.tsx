...
const columns: Column<NotificationLog>[] = [
  {
    ...
    header: "Subject",
    render: (r) => (
      <span className="font-medium text-[#ececec] max-w-xs truncate block">
        {r.subject}
      </span>
    ),
  },
  {
    ...
    header: "Channel",
    render: (r) => (
      <span className="font-mono text-sm text-[#9b9b9b]">{r.channel_name}</span>
    ),
  },
  {
    key: "severity",
  ...
  },
  {
    ...
    render: (r) => (
      <span className="text-sm text-[#9b9b9b]">{formatShortDate(r.sent_at)}</span>
    ),
  },
  {
    key: "error",
    ...
    <Card>
      <CardHeader>
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-lg font-semibold text-[#ececec]">Notification Logs</h2>
        </div>
        <div className="flex gap-2">
          <select
            ...
            className="px-3 py-1.5 border border-[#424242] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
