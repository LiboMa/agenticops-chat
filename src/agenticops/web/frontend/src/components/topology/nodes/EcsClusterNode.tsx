...
function EcsClusterNodeInner({ data, selected }: NodeProps) {
  ...
  return (
    <div
      className={cn(
        "relative rounded-lg border-2 border-cyan-400 bg-gradient-to-br from-cyan-50 to-sky-50 px-3 py-2 min-w-[200px]  transition-all duration-200 hover: hover:-translate-y-0.5",
