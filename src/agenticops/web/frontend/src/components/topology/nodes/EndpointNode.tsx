...
function EndpointNodeInner({ data, selected }: NodeProps) {
  ...
  return (
    <div
      className={cn(
        "relative rounded-lg border-2 border-indigo-400 bg-gradient-to-br from-indigo-50 to-violet-50 px-3 py-2 min-w-[180px]  transition-all duration-200 hover: hover:-translate-y-0.5",
